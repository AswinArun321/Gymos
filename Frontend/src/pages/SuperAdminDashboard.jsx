        ...
        <div className="flex h-screen bg-slate-100 font-sans overflow-hidden">
            ...
            <div className="w-64 bg-slate-950 text-white flex flex-col shadow-2xl z-20">
                <div className="p-6 flex items-center gap-3 border-b border-slate-800">
                    ...
                    <h1 className="text-2xl font-black tracking-tight text-white">GymOS <span className="text-emerald-500 text-sm align-top"></span></h1>
                </div>
                                            ...
                                            {stats.recentGyms.length === 0 ? (
                                                ...
                                                stats.recentGyms.map(gym => (
                                                    <tr key={gym.gym_id} className="border-b border-slate-50 hover:bg-slate-50 transition-colors">
                                                        ...
                                                        <td className="p-4">
                                                            {/* 4. Updated button to set state and open modal */}
                                                            <button 
                                                                onClick={() => {
                                                                    setSelectedGym(gym);
